...
const Card = ({productName,productPrice}) => {
    const [productStatus, setProductStatus] = useState("In Stock")
    const updateProductStatus = ()=>{
        setProductStatus("Added to Card")
    }
  return (
    <div>
            <div className="flex font-serif">
        <div className="flex-none w-52 relative">
            <img src="https://tailwindcss.com/_next/static/media/fancy-suit-jacket.edfeb695.jpg" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
        </div>
            ...
            <div className="flex-auto flex space-x-4 pr-4">
                ...
                <button onClick={updateProductStatus} className="flex-none w-1/2 h-12 uppercase font-medium tracking-wider border border-slate-200 text-slate-900" type="button">
                Add to bag
                </button>
            </div>
